...
const PupType = {
    paddleSize: {color: "dodgerblue", symbol: "="},
    life: {color: "hotpink", symbol: "+"},
    stickyPaddle: {color: "forestgreen", symbol: "~"},
    super: {color: "magenta", symbol: "s"}
}
const Debuff={
    speed:{color:"red",sumbol:"t"},
    paddleSize1:{color:"blue",symbol:"l"}
}
...
var soundBrick = new Audio("sounds/brick.m4a");
var soundPaddle = new Audio("sounds/paddle.m4a");
var soundPowerup = new Audio("sounds/powerup.m4a");
var soundWall = new Audio("sounds/wall.m4a");
...
function drawPups() {
    ...
    for (let pup of pups) {
        ...
        ctx.drawImage(heart, pup.x - pup.w * 0.5, pup.y - pup.h * 0.5,pup.w,pup.h);
    }
}
